...
export const assumptions = () => {
    ...
    let casthouse = {
        ...
        // thermalEnergyUsage: 0.93, // Gj per Ton
        whiteDrossPrice: 462, // USD per Ton - July 2021
        // remeltEnergy: 4.92, // Mwh per Ton
        // remeltCost: {electric: 174, gas: 52, oil: 14}, // USD per Ton - USA
        // furnaceUsage: {electric: 0.1, gas: 0.325, oil: 0.35}, // Mwh per Ton - Einar Smárason
    };
